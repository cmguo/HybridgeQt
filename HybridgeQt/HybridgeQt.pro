...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../../QtComposition/QtComposition/release/ -lQtComposition
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../../QtComposition/QtComposition/debug/ -lQtCompositiond
else:unix: LIBS += -L$$OUT_PWD/../../QtComposition/QtComposition/ -lQtComposition

INCLUDEPATH += $$PWD/../../QtComposition/QtComposition
DEPENDPATH += $$PWD/../../QtComposition/QtComposition
