...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../ -lHybridgeQt
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../ -lHybridgeQtd
else:unix: LIBS += -L$$OUT_PWD/../ -lHybridgeQt

INCLUDEPATH += $$PWD/../HybridgeQt
DEPENDPATH += $$PWD/../HybridgeQt
